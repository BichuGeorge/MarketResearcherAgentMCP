...
GOOGLE_API_KEY = os.environ.get("GOOGLE_SEARCH_API", "AIzaSyCsjeScNo2G5FnV9ZE4sY_ZPigyxe-R_xw")
SEARCH_ENGINE_ID = os.environ.get("SEARCH_ENGINE_ID", "739cdac5277be4d9a")
